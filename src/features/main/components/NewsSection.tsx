...
import type { NewsSummary } from "@/stores/useNewsStore";

export default function NewsSection() {

    const { t } = useTranslation();
    const navigate = useNavigate();
    const fetchSummary = useNewsStore((s) => s.fetchSummary);
    const data = useNewsStore((s) => s.summary);
    const loading = useNewsStore((s) => s.summaryLoading);
    const error = useNewsStore((s) => s.summaryError);
